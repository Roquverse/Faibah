...
export const ProjectsApi = {
  ...
  getProposal: (proposalId: string) => fetchApi(`/projects/proposals/${proposalId}`),
...
export const ChannelsApi = {
  ...
  postMessage: (projectId: string, data: { channelName: string, content: string, senderId?: string, attachmentUrl?: string, messageType?: string, mentions?: any[] }) => fetchApi(`/projects/${projectId}/channel/messages`, { method: 'POST', body: JSON.stringify(data) }),
};
