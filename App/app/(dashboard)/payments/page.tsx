        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full md:w-auto">
          <div className="relative w-full sm:w-auto hidden md:block">
            ...
            <input 
              ...
              className="pl-9 pr-4 py-2.5 bg-white border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-gray-200 transition-all w-full sm:w-64"
            />
          </div>
          <button className="flex items-center justify-center gap-2 px-5 py-2.5 border border-gray-200 bg-white text-gray-900 text-sm font-bold rounded-xl hover:bg-gray-50 transition-colors w-full sm:w-auto">
            <Filter className="w-4 h-4" />
            Filter
          </button>
          <button className="flex items-center justify-center gap-2 bg-[#FBDF4B] text-gray-900 px-5 py-2.5 rounded-xl text-sm font-bold hover:bg-[#F3D53C] transition-colors border border-transparent shrink-0 w-full sm:w-auto">
