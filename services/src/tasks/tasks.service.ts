...
import { TaskStatus, TaskPriority, ScheduleEventType } from '@prisma/client';
...
export class TasksService {
  ...
  async createTask(projectId: string, data: any) {
    ...
    const scheduleEvent = await this.prisma.scheduleEvent.create({
      data: {
        projectId,
        title: task.title,
        description: data.scheduleDescription || data.description || null,
        type: (data.scheduleType as ScheduleEventType) || ScheduleEventType.DEADLINE,
        startTime,
        endTime,
