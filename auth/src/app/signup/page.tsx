...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col lg:flex-row bg-white">
      ...
      <div className="w-full lg:w-1/2 flex flex-col p-6 sm:p-8 lg:p-12 xl:p-20 bg-white min-h-screen relative overflow-y-auto">
        <div className="mb-4 lg:mb-0 lg:absolute lg:top-12 lg:left-12 flex items-center justify-center lg:justify-start">
          <img src="/logo.png" alt="Faibah" className="w-[140px] lg:w-[180px]" />
        </div>

        <div className="flex-1 flex flex-col justify-center max-w-[420px] w-full mx-auto mt-6 lg:mt-0">
