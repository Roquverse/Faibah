...
export default function SettingsPage() {
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 max-w-7xl mx-auto w-full font-sans min-h-[calc(100vh-5rem)] bg-[#F8F9FA] dark:bg-transparent">
      ...
      <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full md:w-auto">
          {successMsg && (
            <div className="px-4 py-2 bg-green-50 border border-green-200 text-green-700 rounded-lg text-sm font-medium animate-in fade-in slide-in-from-right-4 sm:mr-2">
              {successMsg}
            </div>
          )}
          {errorMsg && (
            <div className="px-4 py-2 bg-red-50 border border-red-200 text-red-700 rounded-lg text-sm font-medium animate-in fade-in slide-in-from-right-4 sm:mr-2">
              {errorMsg}
            </div>
          )}

          <div className="flex gap-3 w-full sm:w-auto">
            <button className="flex-1 sm:flex-none px-4 py-2 bg-white border border-gray-200 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-50 transition-colors">
              Cancel
            </button>
            <button
              onClick={handleSave}
              disabled={isSaving}
              className="flex-1 sm:flex-none flex items-center justify-center gap-2 bg-[#1C0A3E] text-white px-5 py-2 rounded-lg text-sm font-medium hover:bg-[#2A105D] transition-colors disabled:opacity-50 whitespace-nowrap"
            >
